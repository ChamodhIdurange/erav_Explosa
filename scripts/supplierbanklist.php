...
// DB table to use
$table = 'tbl_supllier_bank_details';

// Table's primary key
$primaryKey = 'idtbl_supllier_bank_details';
...
// indexes
$columns = array(
	array( 'db' => '`u`.`idtbl_supllier_bank_details`', 'dt' => 'idtbl_supllier_bank_details', 'field' => 'idtbl_supllier_bank_details' ),
...
$joinQuery = "FROM `tbl_supllier_bank_details` AS `u`";
