...
$joinQuery = "FROM `tbl_customerinquiry` AS `u` JOIN `tbl_customerinquiry_detail` AS `ua` ON (`ua`.`tbl_customerinquiry_idtbl_customerinquiry` = `u`.`idtbl_customerinquiry`) JOIN `tbl_customer` AS `ub` ON (`ub`.`idtbl_customer` = `u`.`tbl_customer_idtbl_customer`)";
