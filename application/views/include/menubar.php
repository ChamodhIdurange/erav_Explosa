...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
			...
			<div class="collapse <?php if($functionmenu=="Supplier"  | $functionmenu=="Customer" | $functionmenu=="Employee" | $functionmenu=="Location" | $functionmenu=="Suppliertype" | $functionmenu=="Reeltype" | $functionmenu=="Gsm" | $functionmenu=="Measurements"){echo 'show';} ?>"
				...
				<nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
					...
					<a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Employee'; ?>">Employees</a>
					...
					<a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Reeltype'; ?>">Reel Type</a>
					...
					<a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Measurements'; ?>">Measurments</a>
                    <?php } ?>
				</nav>
			</div>
            <?php } if(menucheck($menuprivilegearray, 11)==1 | menucheck($menuprivilegearray, 12)==1 | menucheck($menuprivilegearray, 16)==1 | menucheck($menuprivilegearray, 17)==1){?>
			<a class="nav-link p-0 px-3 py-2 collapsed text-dark" href="javascript:void(0);" data-toggle="collapse"
			...
			<div class="collapse <?php if($functionmenu=="Materialmaincategory" | $functionmenu=="Rowmaterials" | $functionmenu=="Fliinformation" | $functionmenu=="Cuttype"){echo 'show';} ?>"
            ...
            <?php } if(menucheck($menuprivilegearray, 18)==1 | menucheck($menuprivilegearray, 19)==1){?>
			<a class="nav-link p-0 px-3 py-2 collapsed text-dark" href="javascript:void(0);" data-toggle="collapse"
			...
			<div class="collapse <?php if($functionmenu=="Machinetype" | $functionmenu=="Machine"){echo 'show';} ?>"
			...
			<div class="collapse <?php if($functionmenu=="Mainitems" | $functionmenu=="Itemprofile"){echo 'show';} ?>"
				id="collapsemainitem" data-parent="#accordionSidenav">
				<nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
					<?php if(menucheck($menuprivilegearray, 14)==1){ ?>
					<a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Mainitems'; ?>">Main Items</a>
					<?php } if(menucheck($menuprivilegearray, 15)==1){ ?>
					<a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Itemprofile'; ?>">Item Profiles</a>
                    <?php } ?>
				</nav>
			</div>
